...
import 'package:appointment_app/file_manager.dart';
                        ...
                        TextFormField(
                          ...
                          validator: (value) {
                            if (value!.isEmpty) {
                              ...
                              return "School ID must be 11 characters long!";
                            }
                            return null;
                          },
                          onSaved: (value) => _schoolId = value!,
                        ),
                        const SizedBox(
                          height: 30,
                        ),
                  ...
                  child: ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        if (_validate) {
                          ...
                          bool isRegistered =
                              await FileManager.isUserRegistered(
                                  _schoolId, _password);
                          if (isRegistered) {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                                content: Text(
                                    "No registered user found for the entered information")));
                          }
                        } else {
                          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
